...
create_clock -period 10.000 -name CLK100MHZ -waveform {0.000 5.000} -add [get_ports sys_clk_100mhz]
...
##Buttons
set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS33} [get_ports cpu_rstn];
